...
import { Select as BaseSelect, SelectProps, SelectOwnerState, SelectRootSlotProps } from "@mui/base/Select"
...
const SelectButton = React.forwardRef(function SelectButton<TValue extends {}, Multiple extends boolean>(
         ...
         slotProps={{
            root: (ownerState: SelectOwnerState<string, false>) => ({
               ...
               className: clsx(
                  ...
                  ownerState.focusVisible && "border-blue-400 outline-[3px] outline-solid outline-blue-200"
               ),
            }),
            listbox: {
               ...slotProps.listbox,
...
export const Slider = React.forwardRef(function Slider(props: SliderProps, ref: React.ForwardedRef<HTMLElement>) {
   const {
      slotProps = {
         root: {},
         rail: {},
   ...
   return (
      <BaseSlider
         ...
         slotProps={{
            ...
            thumb: {
               ...slotProps.thumb,
               className: "absolute w-5 h-5 ml-[-8px] mt-[-7.5px] box-border rounded-[50%] outline-0 bg-white",
